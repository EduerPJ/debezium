...
curl -X POST http://localhost:8083/connectors \
  ...
  -d '{
    ...
    "config": {
        ...
        "tasks.max": "1",
        "connection.url": "jdbc:mysql://192.168.101.7:3306/jdbc_copia?serverTimezone=America/Bogota&useSSL=false&allowPublicKeyRetrieval=true&rewriteBatchedStatements=true&cachePrepStmts=true",
